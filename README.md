...
git init
git add .
git commit -m "Add ML pipeline, FastAPI backend, frontend"
...
I cannot run external deployments or push to GitHub from this environment. After running the notebook to generate artifacts, please deploy and push using your accounts.
